...
#----------------------------- Working while 60s -----------------------------#
        ...
        speech = onset + (srate*3) + 1   # +1 이 맞을지 다시 재 확인. / zero array 까지 포함.
        while i != 47:
            ...
            eeg_data = librosa.resample(eeg_data, (len(eeg_data.T)), 125)
            aux_data = librosa.resample(aux_data, (len(aux_data.T)), 125)
            print(len(eeg_data.T))
