...
screen = visual.Window([960, 900], screen=2, pos=[600, 0], fullscr=True,
...
text = visual.TextStim(screen, text="When you are ready to the task, \n press 'space bar' ", height=50, color=[1, 1, 1], wrapWidth=1500)
text.draw()
screen.flip()
key1 = event.waitKeys(keyList=["space"], clearEvents=True)
text = visual.TextStim(screen, text="The task starts after 3 seconds ", height=50, color=[1, 1, 1], wrapWidth=1500)
text.draw()
screen.flip()
time.sleep(3)
...
while tr < 30:
    ...
    if 1 in input[aux_channels, :][1, :]:   # if the trigger is detected at 12 pin, start process. (include beep sound)
        ...
        if state == "Train set":
            ...
            print("\n==================================\n")
            print("Present Accuracy = {0}%".format(np.mean(acc[tr-14:tr-13,:] * 100)))
            print("\n==================================\n")
        ...
        text = visual.TextStim(screen, text="When you are ready to next step,\n press 'space bar' ", height=50,
...
# END
print("The End")
final = visual.TextStim(screen, text="The End", height=50, color=[1, 1, 1], wrapWidth=2000)
final.draw()
screen.flip()
time.sleep(3)
